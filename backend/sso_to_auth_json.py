#!/usr/bin/env python3
"""SSO cookie to CPA / Grok2API auth conversion core.

The Web registration flow imports OAuth conversion and auth-file writers from
this module.
"""
...
_NEXT_ACTION_CACHE_PATH = Path(__file__).resolve().parent.parent / "data" / ".next_action_id.cache"
