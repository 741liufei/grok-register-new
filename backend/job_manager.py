# -*- coding: utf-8 -*-
"""Background registration job control for the web console.

Reuses the registration core via temporary hooks on registration_log / RegistrationStopController.
"""
